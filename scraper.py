...
def get_mountains_urls(urls_filename = 'mountains_urls.pickle', url = 'https://www.mountain-forecast.com/countries/India?top100=yes'):
...
def scrape_forecasts():
    """ Calling the different functions necessary to scrape mountain weather forecasts and save the data """

    start = time.time()
    print('\nGetting Mountain URLS')
    #mountains_urls = get_mountains_urls(urls_filename = '10_mountains_urls.pickle', url = 'https://www.mountain-forecast.com/countries/India')
    ...
    print('Process complete, the process took {} seconds\n'.format(round(time.time() - start, 2)))
